...
import "./interfaces/IJoeV2Router02.sol";
...
contract ToleranceCheckStatelessAvax {
    constructor(
        ...
        IJoeV2Router02 router = IJoeV2Router02(routerAddress);
        ...
        {
            router.swapAVAXForExactTokens{value: result[0]}(result[2], path, address(this), block.timestamp);
        }
